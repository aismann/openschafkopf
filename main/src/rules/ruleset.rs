...
impl SRuleGroup {
    ...
    pub fn allowed_rules<'retval, 'hand : 'retval, 'rules : 'retval>(&'rules self, hand: SFullHand<'hand>) -> impl TClonableIterator<Option<&'rules dyn TActivelyPlayableRules>> + 'retval {
...
pub fn allowed_rules<'retval, 'hand : 'retval, 'rules : 'retval>(vecrulegroup: &'rules [SRuleGroup], hand: SFullHand<'hand>) -> impl TClonableIterator<Option<&'rules (dyn TActivelyPlayableRules + 'rules)>> + 'retval {
    vecrulegroup.iter()
